...
bool Helper::init()
{
    ...
    auto xuanxiang1 = Sprite::create("/HelperScene/help_1-hd_71_normal.PNG");
    ...
    else
    {
        ...
        this->addChild(xuanxiang1, 0);
    }
    auto xuanxiang2 = Sprite::create("/HelperScene/help_1-hd_66_normal.PNG");
